...
<body class="antialiased bg-neutral-200 min-h-screen w-full flex flex-col overflow-x-hidden relative">
  ...
  <div class="max-w-3xl mx-auto mb-8">
    <h1 class="font-righteous text-center text-neutral-800 text-3xl my-4">Tambah Artikel</h1>
    <form action="/artikel/tambah" method="POST" enctype="multipart/form-data" class="mt-4">
      @csrf
      ...
      <div class="mb-4">
        ...
        <textarea name="content" id="content" class="w-full border border-gray-300 rounded-lg py-2 px-4 focus:outline-none focus:ring focus:border-blue-300"
          rows="8" placeholder="Masukkan isi artikel"></textarea>
        @error('content')
